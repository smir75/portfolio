// src/scenes/stations/StationDish.jsx
    ...
    <group position={s.pos} quaternion={q}>
      ...
      <group position={[0, 1.1, 0]}>
        <HUDPanel
          ...
          lines={s.lines}
          kRef={kRef}
          onFocus={() => onFocus?.(s.id)}   // simple clic = focus
          stationId={s.id}                  // double-clic = ouvrir (event global)
