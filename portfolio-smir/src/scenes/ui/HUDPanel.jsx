...
export default function HUDPanel({ type, color="#7cc6ff", title, lines=[], kRef, onClick, highContrast }) {
  ...
  if (type === "round") {
    return (
      <Billboard follow distanceFactor={8} {...commonProps}>
        <mesh ref={plane}><planeGeometry args={[1.7, 0.7]} /><meshBasicMaterial transparent blending={THREE.AdditiveBlending} depthTest={false} depthWrite={false} color={color} /></mesh>
        ...
        <mesh ref={scan} position={[0, 0, 0.001]}><planeGeometry args={[1.66, 0.06]} /><meshBasicMaterial transparent blending={THREE.AdditiveBlending} depthTest={false} depthWrite={false} color={color} /></mesh>
  ...
  if (type === "totem") {
    return (
      <Billboard follow distanceFactor={8} {...commonProps}>
        <mesh ref={plane}><planeGeometry args={[0.9, 1.3]} /><meshBasicMaterial transparent blending={THREE.AdditiveBlending} depthTest={false} depthWrite={false} color={color} /></mesh>
        ...
        <mesh ref={scan} position={[0, 0, 0.001]}><planeGeometry args={[0.88, 0.05]} /><meshBasicMaterial transparent blending={THREE.AdditiveBlending} depthTest={false} depthWrite={false} color={color} /></mesh>
  ...
  if (type === "hex") {
    return (
      <Billboard follow distanceFactor={8} {...commonProps}>
        <mesh ref={plane}><circleGeometry args={[0.9, 6]} /><meshBasicMaterial transparent blending={THREE.AdditiveBlending} depthTest={false} depthWrite={false} color={color} /></mesh>
  ...
  return (
    <Billboard follow distanceFactor={8} {...commonProps}>
      <mesh ref={plane}><planeGeometry args={[1.8, 0.8]} /><meshBasicMaterial transparent blending={THREE.AdditiveBlending} depthTest={false} depthWrite={false} color={color} /></mesh>
